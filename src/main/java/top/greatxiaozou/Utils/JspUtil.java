...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "d:/intellij/work_space/javaweb/web", null,true);
            File file = new File("d:/intellij/work_space/javaweb/web/index.jsp");
    ...
    public static void compileJsp(Context context, File file) throws JasperException {
        ...
        String workPath = new File(Utils.workFolder, subFolder).getAbsolutePath() + File.separator;
    ...
    public static String getServletPath(String uri, String subFolder) {
        ...
        File tempFile = FileUtil.file(Utils.workFolder, subFolder, tempPath);
    ...
    public static String getJspServletClassName(String uri, String subFolder) {
        File tempFile = FileUtil.file(Utils.workFolder, subFolder);
